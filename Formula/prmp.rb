class Prmp < Formula
  ...
  url "https://github.com/khaliqgant/prompt-package-manager/releases/download/v0.1.2/prpm-macos-x64"
  ...
  if Hardware::CPU.arm?
    url "https://github.com/khaliqgant/prompt-package-manager/releases/download/v0.1.2/prpm-macos-arm64"
