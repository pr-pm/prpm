...
export interface CanonicalPackage {
  ...
  format: 'cursor' | 'claude' | 'continue' | 'windsurf' | 'copilot' | 'kiro' | 'agents.md' | 'openskills' | 'gemini' | 'ruler' | 'generic' | 'mcp';
  ...
  // Source information
  sourceFormat?: 'cursor' | 'claude' | 'continue' | 'windsurf' | 'copilot' | 'kiro' | 'agents.md' | 'openskills' | 'gemini' | 'ruler' | 'generic';
  sourceUrl?: string;
