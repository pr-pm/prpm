...
export function fromKiro(
  ...
  // Parse markdown body and extract H1 title
  const { sections, h1Title } = parseMarkdown(body);
 ...
 */
function parseMarkdown(content: string): { sections: Section[]; h1Title?: string } {
