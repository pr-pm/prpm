/**
 * Replit Format Converter
 * Converts canonical format to Replit replit.md format
 *
 * File structure:
 * - Standard location: replit.md in project root
 * - Simple markdown format with project configuration
 * - No frontmatter
 */
...
/**
 * Convert canonical package to Replit format
 */
export function toReplit(
...
/**
 * Convert canonical content to Replit markdown
 */
function convertContent(
  ...
  for (const section of pkg.content.sections) {
    // Skip metadata, tools, and persona (not applicable to Replit)
    if (
...
/**
 * Convert individual section to Replit format
 */
...
/**
 * Convert instructions to Replit format
 */
...
/**
 * Convert rules to Replit format
 */
...
/**
 * Convert examples to Replit format
 */
...
/**
 * Convert context to Replit format
 */
...
/**
 * Detect if content is already in Replit format
 */
export function isReplitFormat(content: string): boolean {
  // Replit files are simple markdown files without frontmatter
...
/**
 * Generate suggested filename for Replit file
 * Format: replit.md
 */
