      ...
      >
        ...
        <div className="mb-6">
          <h3 className="text-lg font-semibold mb-3">
            Included Packages ({collection.packages.length})
          </h3>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h4 className="font-semibold text-white">{pkg.package_name}</h4>
                    ...
                    {pkg.package_description && (
                      <p className="text-sm text-gray-400">{pkg.package_description}</p>
                    )}
                  </div>
                </div>
              </div>
