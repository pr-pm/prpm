...
`}
          ...
          <p className="text-gray-300 leading-relaxed mb-6">
            PRPM (Prompt Package Manager) makes it easy to discover, install, and share agents.md packages. With <strong>6,000+ packages</strong> across multiple formats, PRPM is the largest cross-platform repository for AI coding guidance.
          </p>
