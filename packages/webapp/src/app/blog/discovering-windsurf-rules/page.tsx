...
prpm publish`}</code></pre>
          ...
          <p className="mt-6">Browse all 4000+ packages at <Link href="/search?format=windsurf" className="text-prpm-accent hover:underline">prpm.dev/search</Link></p>
          ...
          <div className="not-prose my-12 p-8 bg-gradient-to-br from-prpm-accent/10 to-prpm-green/10 border border-prpm-accent/30 rounded-2xl">
            ...
            <p className="text-gray-300 mb-6">
              Get CLI installation, quality metrics, testing playground, and version control for your Windsurf AI editor. 4000+ packages available now.
            </p>
