...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "How PRPM complements Anthropic's Claude Code plugin system. Learn why cross-platform and platform-specific solutions strengthen the AI coding ecosystem.",
    date: "2025-10-27",
    author: "PRPM Team",
    readTime: "6 min read",
