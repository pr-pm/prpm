...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: "Finding Cursor Rules: Beyond cursor.directory",
    excerpt: "PRPM vs cursor.directory for Cursor rules. CLI installation, version control, format conversion, and testing playground.",
    date: "2025-11-04",
    author: "PRPM Team",
    readTime: "5 min read",
  ...
  },
  {
    ...
    title: "Discovering Kiro Steering Rules: First Centralized Marketplace",
    excerpt: "PRPM is the first centralized marketplace for Kiro steering files. CLI install, version control, and testing playground.",
    date: "2025-11-04",
    author: "PRPM Team",
    readTime: "4 min read",
  ...
  },
  {
    ...
    title: "GitHub Copilot Instructions: Unified Discovery",
    excerpt: "Find Copilot instructions without searching Gists, repos, and Reddit. CLI install, version control, and testing.",
    date: "2025-11-04",
    author: "PRPM Team",
    readTime: "4 min read",
  ...
  },
  {
    ...
    title: "Windsurf Rules: Centralized from Day One",
    excerpt: "Skip the fragmentation phase. PRPM brings centralized discovery to Windsurf rules from launch.",
    date: "2025-11-04",
    author: "PRPM Team",
    readTime: "4 min read",
