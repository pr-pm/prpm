...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "How PRPM compares to ctx.directory, SkillsMP, and Claude Plugins for discovering Claude skills. Learn why unified package management beats scattered marketplaces.",
    date: "2025-11-04",
    author: "PRPM Team",
  ...
  },
  {
    ...
    excerpt: "How PRPM improves on cursor.directory for discovering Cursor rules. Get CLI installation, version control, format conversion, and a testing playground.",
    date: "2025-11-04",
    author: "PRPM Team",
    readTime: "9 min read",
  ...
  {
    slug: "discovering-kiro-steering-rules",
    title: "Discovering Kiro Steering Rules: Why PRPM Wins",
    excerpt: "How PRPM brings centralized discovery to Kiro steering files. Stop searching GitHub repos and Discord—get CLI installation, version control, and testing.",
    date: "2025-11-04",
    author: "PRPM Team",
    readTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "How PRPM improves Copilot instructions discovery beyond scattered Gists and GitHub repos. Get CLI install, version control, and testing.",
    date: "2025-11-04",
    author: "PRPM Team",
    readTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "PRPM brings centralized discovery to Windsurf rules from day one. Stop searching GitHub—get CLI installation, version control, and testing.",
    date: "2025-11-04",
    author: "PRPM Team",
    readTime: "7 min read",
