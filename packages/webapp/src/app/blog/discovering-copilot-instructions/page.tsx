        ...
        ">
          ...
          <div className="not-prose mb-8">
            <ul className="list-disc ml-6 text-gray-300 space-y-2">
              ...
              <li><strong>7000+ packages:</strong> Largest collection including awesome-copilot packages</li>
            ...
            <table className="w-full border-collapse text-sm">
              ...
              <tbody className="text-gray-300">
                ...
                <tr className="border-b border-prpm-border/30">
                  ...
                  <td className="p-3 text-green-400">7000+ packages</td>
...
prpm update`}</code></pre>
          ...
          <p className="mt-6">Browse all 7000+ packages at <Link href="/search?format=copilot" className="text-prpm-accent hover:underline">prpm.dev/search</Link></p>
