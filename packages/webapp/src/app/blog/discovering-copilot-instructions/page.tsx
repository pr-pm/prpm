        ...
        ">
          ...
          <div className="not-prose mb-8">
            <ul className="list-disc ml-6 text-gray-300 space-y-2">
              ...
              <li><strong>4000+ packages:</strong> Largest collection including awesome-copilot packages</li>
            ...
            <table className="w-full border-collapse text-sm">
              ...
              <tbody className="text-gray-300">
                ...
                <tr className="border-b border-prpm-border/30">
                  ...
                  <td className="p-3 text-green-400">4000+ packages</td>
...
prpm update`}</code></pre>
          ...
          <p className="mt-6">Browse all 4000+ packages at <Link href="/search?format=copilot" className="text-prpm-accent hover:underline">prpm.dev/search</Link></p>
          ...
          <div className="not-prose my-12 p-8 bg-gradient-to-br from-prpm-accent/10 to-prpm-green/10 border border-prpm-accent/30 rounded-2xl">
            ...
            <p className="text-gray-300 mb-6">
              Get CLI installation, quality metrics, testing playground, and version control for your GitHub Copilot workflow. 4000+ packages including all awesome-copilot instructions.
            </p>
