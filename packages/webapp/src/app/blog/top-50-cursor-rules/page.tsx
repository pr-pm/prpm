...
export const metadata: Metadata = {
  ...
  description: "Discover the top 50 Cursor rules from 7,000+ packages. Install production-ready AI assistance for React, TypeScript, Python, Go, and more. PRPM converts any package to Cursor rules.",
  ...
  openGraph: {
    ...
    description: "Discover the top 50 Cursor rules from 7,000+ packages. Install production-ready AI assistance for React, TypeScript, Python, Go, and more.",
  },
}
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        ">
          ...
          <div className="not-prose mb-16">
            ...
            <ul className="text-gray-300 space-y-3 mb-8 list-disc ml-6">
              <li>7,000+ packages across all formats (Claude skills, agents, prompts)</li>
