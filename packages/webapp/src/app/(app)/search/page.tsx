                        ...
                        {selectedFormat && (
                          <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6 max-w-2xl mx-auto text-left">
                            ...
                            <p className="text-gray-400 text-sm mt-3">
                              This means you have access to <strong>4,000+ packages</strong> across all formats, not just {selectedFormat}-specific ones!
                            </p>
                          </div>
                        )}
                      </div>
                        ...
                        {selectedFormat && total < 50 && (
                          <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4 mb-4">
                            ...
                            <p className="text-gray-300 text-sm mb-2">
                              Only {total} native <strong>{selectedFormat}</strong> {total === 1 ? 'package' : 'packages'} found. You can access <strong>4,000+ packages</strong> by installing packages from other formats:
                            </p>
