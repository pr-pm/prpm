...
export const metadata: Metadata = {
  ...
  description: 'The largest collection of Cursor rules, Claude agents, and slash commands. 4,000+ packages including cursor slash commands, claude slash commands, and claude plugins. Install AI coding tools with one command.',
  keywords: [
    'cursor rules',
  ...
  openGraph: {
    ...
    description: 'The largest collection of Cursor rules, Claude agents, and slash commands. 4,000+ packages including cursor slash commands, claude slash commands, and claude plugins.',
    siteName: 'PRPM',
    images: [
      {
        url: '/og-image.png',
