...
describe('Postgres Search', () => {
  ...
  describe('empty query handling', () => {
    ...
    it('should return all public packages when query is empty', async () => {
    ...
    it('should filter by type with empty query', async () => {
    ...
    it('should filter by tags with empty query', async () => {
      const result = await search.search('', {
        tags: ['mcp'],
        limit: 20,
        offset: 0,
    ...
    it('should filter by category with empty query', async () => {
      const result = await search.search('', {
    ...
    it('should combine type and tags filters with empty query', async () => {
      const result = await search.search('', {
        type: 'claude',
        tags: ['claude-skill'],
        limit: 20,
  ...
  describe('text search with filters', () => {
    ...
    it('should combine text query with type filter', async () => {
      const result = await search.search('Python', {
        type: 'claude',
        limit: 20,
        offset: 0,
    ...
    it('should combine text query with tags filter', async () => {
      const result = await search.search('Python', {
        tags: ['cursor-rule'],
        limit: 20,
        offset: 0,
  ...
  describe('verified and featured filtering', () => {
    ...
    it('should combine verified and featured filters', async () => {
      const result = await search.search('', {
        verified: true,
        featured: true,
        limit: 20,
