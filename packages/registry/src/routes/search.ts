...
const FORMAT_ENUM = ['cursor', 'claude', 'claude-plugin', 'continue', 'windsurf', 'copilot', 'kiro', 'agents.md', 'gemini', 'ruler', 'droid', 'opencode', 'codex', 'amp', 'trae', 'aider', 'zencoder', 'replit', 'generic', 'mcp'] as const;
