...
const TrackDownloadSchema = z.object({
  ...
  format: z.enum(['cursor', 'claude', 'claude-plugin', 'continue', 'windsurf', 'copilot', 'kiro', 'agents.md', 'gemini', 'ruler', 'droid', 'opencode', 'codex', 'amp', 'trae', 'aider', 'zencoder', 'replit', 'generic', 'mcp']).optional(),
      ...
      schema: {
        ...
        body: {
          ...
          properties: {
            ...
            format: {
              type: 'string',
              enum: ['cursor', 'claude', 'claude-plugin', 'continue', 'windsurf', 'copilot', 'kiro', 'agents.md', 'gemini', 'ruler', 'droid', 'opencode', 'codex', 'amp', 'trae', 'aider', 'zencoder', 'replit', 'generic', 'mcp'],
    ...
    '/popular',
    {
      schema: {
        ...
        querystring: {
          ...
          properties: {
            limit: { type: 'number', default: 10 },
            type: { type: 'string', enum: ['cursor', 'claude', 'claude-plugin', 'continue', 'windsurf', 'copilot', 'kiro', 'agents.md', 'gemini', 'ruler', 'droid', 'opencode', 'trae', 'aider', 'zencoder', 'replit', 'generic', 'mcp'] },
          },
        },
      },
    },
