...
**Arguments:**
- `package-name` - Full package name (e.g., `typescript-rules`)
...
prpm info typescript-best-practices

# View specific version
prpm info typescript-best-practices --version 1.2.0

# JSON output for scripting
prpm info typescript-rules --json
```
...
prpm install typescript-rules1 typescript-rules2 typescript-rules3

# Install specific version
prpm install typescript-rules --version 2.1.0

# Install with custom name
prpm install long-package-name --as short-name

# Force reinstall
prpm install typescript-rules --force
```
...
```bash
#!/bin/bash
if prpm install typescript-rules; then
