...
- **popular** - View most popular packages
...
- **catalog** - Generate catalog of available formats
...
prpm info some-author/react-rules

# Install the package
prpm install some-author/react-rules
```
